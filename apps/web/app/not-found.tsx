...
export default function NotFound() {
  return (
    ...
    >
      ...
      <p className="max-w-[600px] text-body-lg text-fg-muted">
      ...
      <div className="flex flex-wrap items-center justify-center gap-3">
        ...
        <Link
          href="/dashboard"
          className="inline-flex h-12 items-center rounded-md bg-primary px-5 text-body text-fg-on-primary transition-colors duration-[--duration-fast] hover:bg-primary-hover"
        >
          Back to dashboard
        </Link>
        <Link
